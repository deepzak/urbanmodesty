...
<div class="<?php if($isAccordion): ?>tabs accordion checkout-accordion<?php else: ?>checkout-default<?php endif; ?>">
  <?php if($isAccordion): ?><a class="tab-title checkout-accordion-title" id="tab_0"><span><?php _e('Coupon', ETHEME_DOMAIN) ?></span></a><?php endif; ?>
  <div class="tab-content tab-login" id="content_tab_0">
