...
<div class="container">
  <div class="row">
    <div class="span12 breadcrumbs">
      ...
      <p class="offer-banner">Free shipping on orders +$99 &amp; easy returns</p>

      <?php $cp_cookie = get_option('um_coupon_name');
      if( isset($_COOKIE['wc_' . $cp_cookie]) && isset($_COOKIE['snp_snppopup-welcome']) ): ?>
      <p id="coupon-code">10% OFF 1 time offer valid for <span class="clock"></span> minutes. Use code <strong style="color: #fa8072;"><?php echo $cp_cookie; ?></strong></p>
      <?php endif; ?>
    </div>
  </div>
</div>
